    ...
    wizardWithSimpleConditionalPage.setForm(_wizardWithSimpleConditionalPage.default).then(function () {
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          _powerAssert.default.equal(wizardWithSimpleConditionalPage.data, submissionData);
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            _powerAssert.default.equal(wizardWithCustomConditionalPage.data, submissionData);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            form.data = submission.data; // Perform calculations and conditions.

            form.calculateValue();
            form.checkConditions(); // Reset the data
