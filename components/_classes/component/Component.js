  ...
  _createClass(Component, [{
    ...
    value: function getModalPreviewTemplate() {
      return this.renderTemplate('modalPreview', {
        previewText: this.getValueAsString(this.dataValue, {
          modalPreview: true
    ...
    value: function checkRefreshOn(changes, flags) {
      ...
      if (!changes.length && (flags === null || flags === void 0 ? void 0 : flags.changed)) {
    ...
    value: function calculateComponentValue(data, flags, row) {
      ...
      var changed = flags.dataSourceInitialLoading || _lodash.default.isEqual(this.dataValue, calculatedValue) ? false : this.setValue(calculatedValue, flags);
      this.calculatedValue = calculatedValue;
      return changed;
    }
    /**
