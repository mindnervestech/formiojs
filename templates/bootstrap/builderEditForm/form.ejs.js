...
'\n    </div>\n    ';
 ...
 __p += '\n    <div style="margin-top: 10px;">\n      <div style="color: green;cursor: pointer;margin-left: 5px;" ref="saveButton">Save Configuration' +
'</div> </div>\n  </div>\n  ';
/* __p += '\n    <div style="margin-top: 10px;">\n      <button class="btn btn-success" style="margin-right: 10px;" ref="saveConfiguration">' +
((__t = (ctx.t('Save'))) == null ? '' : __t) +
'</button>\n      <button class="btn btn-secondary" style="margin-right: 10px;" ref="cancelButton">' +
((__t = (ctx.t('Cancel'))) == null ? '' : __t) +
'</button>\n      <button class="btn btn-danger" ref="removeButton">' +
